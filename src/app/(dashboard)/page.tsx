 ...
 return <div className="commandCenter v92Home v931Home">
  <section className="v931Hero">
   <div className="v931HeroTop">
    <div><span>OWNER COMMAND CENTER</span><h1>{estate.name}</h1><p>{context.selectedYear} · {stage} · {estateBlocks.length} blok · {formatNumber(area)} Ha · {formatNumber(trees)} pohon</p></div>
