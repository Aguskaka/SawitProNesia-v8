...
export function DashboardShell({ children }: { children: ReactNode }) {
  return <div className="appShell premiumShell">
    <aside className="sideRail">
      ...
      <div className="sideFoot"><small>PREMIUM MOBILE-FIRST</small><b>v9.3</b></div>
    </aside>
    <div className="shellBody">
      <header className="mobileTopbar"><Link className="mobileBrand" href="/"><span>🌴</span><b>SawitProNesia</b></Link><div><span className="versionPill">v9.3</span><form action={logout}><button className="mobileAccount" type="submit" title="Keluar"><AppIcon name="user"/></button></form></div></header>
