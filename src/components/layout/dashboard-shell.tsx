...
export function DashboardShell({ children }: { children: ReactNode }) {
  return <div className="appShell premiumShell">
    <aside className="sideRail">
      ...
      <SideNavigation />
      <div className="sideFoot"><small>SAWIT OPERATIONS OS</small><b>v10.5</b><PwaInstallButton /></div>
    </aside>
    <div className="shellBody">
      <header className="mobileTopbar">
        <Link className="mobileBrand" href="/"><BrandMark/><b>SawitProNesia</b></Link>
        <div><PwaInstallButton compact /><span className="versionPill">v10.5</span><form action={logout}><button className="mobileAccount" type="submit" title="Keluar" aria-label="Keluar dari SawitProNesia"><AppIcon name="user"/></button></form></div>
      </header>
